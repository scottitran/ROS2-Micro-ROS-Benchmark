...
class BTN_PUB(Node):
    ...
    def timer_callback(self):
        ...
        start_time = datetime.now()
            #condition = False
        self.get_logger().info('Publishing ... at {}'.format(start_time))

    def makePublisher(self):
        self.stopTimer()
        self.publisher_ = self.create_publisher(self.msg_size, self.publish_topic, self.qos)
        self.startTimer()
    ...
    def sub_callback(self,msg):
        ...
        # self.get_logger().info('latency {}'.format(end_time - start_time))
