...
// // #include "tutorial_interfaces/msg/num500kb.hpp"
...
//   {
//     publisher_ = this->create_publisher<std_msgs::msg::String>("ping", rclcpp::QoS(10).best_effort());
//     subscription_ = this->create_subscription<std_msgs::msg::String>("pong", rclcpp::QoS(10).best_effort(), std::bind(&MinimalPublisher::topic_callback, this, _1));
...
//   {
//     // RCLCPP_INFO(this->get_logger(), "I heard: from publisher '%s'", msg->data.c_str());
//     int i = 0;
//   }
